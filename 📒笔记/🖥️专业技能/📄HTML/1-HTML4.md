...
1. 一个完整的表格由：**表格标题、表格头部、表格主体、表格脚注**四部分组成。
   ![[public/blog/tech_skills/html/HTML_table_structure.png]]
2. 表格涉及到的标签：
	- **`table`**：表格
	- **`caption`**：表格标题（没有属性）
	- **`thead`**：表格头部
