...
![[public/blog/project/博客/个人部署方案/个人部署方案-1.png]]

### 注册

[腾讯云首页](https://cloud.tencent.com/) => 产品 => 域名注册

![[public/blog/project/博客/个人部署方案/个人部署方案-2.png]]

自己想一个域名搜索，被注册了就换一个，直到有中意的

![[public/blog/project/博客/个人部署方案/个人部署方案-3.png]]

购买完成后，右上角点击进入 `控制台`  => 域名注册 => 我的域名

![[public/blog/project/博客/个人部署方案/域名注册.png]]

![[public/blog/project/博客/个人部署方案/域名注册成功.png]]
...
![[public/blog/project/博客/个人部署方案/解析.png]]

直接点 `快速添加解析` ，记录值填 `你的主机IP` 即可

![[public/blog/project/博客/个人部署方案/快速解析.png]]

解析成功后，结果如下

![[public/blog/project/博客/个人部署方案/解析成功.png]]
...
4. **Build Command:** 设置为 `npm run build` 或 `pnpm run build` 。这里根据你自己的 `package.json` 文件的内容进行配置。
	...
	![[public/blog/project/博客/个人部署方案/package-json.png]]
	因此我的配置为 `pnpm build` 。
...
![[public/blog/project/博客/个人部署方案/部署成功.png]]

如果你挂了梯子，你点击这一域名便可以成功访问你的网站了，但是如果你没有梯子，便会被墙。如图所示：

![[public/blog/project/博客/个人部署方案/vercel墙.png]]

### 自定义域名

选择 `Domain` => `Add` ，填入你自己的域名即可。我这里使用的是 ` ryanjoy.top ` 。

![[public/blog/project/博客/个人部署方案/domain配置1.png]]

![[public/blog/project/博客/个人部署方案/domain配置2.png]]

![[public/blog/project/博客/个人部署方案/domain配置3.png]]
...
![[public/blog/project/博客/个人部署方案/添加域名.png]]

输入我们之前注册好的 [域名](#注册) ，点击继续

![[public/blog/project/博客/个人部署方案/域名添加.png]]

方案选择 `FREE`

![[public/blog/project/博客/个人部署方案/free.png]]

`开始快速扫描`

![[public/blog/project/博客/个人部署方案/快速扫描.png]]

后面提示我们更改 DNS 服务器

![[public/blog/project/博客/个人部署方案/更改dns.png]]

回到腾讯云。打开域名界面，勾选域名，修改DNS服务器。

![[public/blog/project/博客/个人部署方案/dns修改.png]]

填入 `Cloudflare` 给出的服务器编码

![[public/blog/project/博客/个人部署方案/服务器配置.png]]
...
![[public/blog/project/博客/个人部署方案/dns不正确.png]]
...
![[public/blog/project/博客/个人部署方案/激活成功.png]]

这表示你已经成功激活 `Cloudflare` 的服务。 `Cloudflare` 控制台会显示如下

![[public/blog/project/博客/个人部署方案/Cloudflare控制台.png]]

点击左侧 DNS => 记录。可以看到之前腾讯云我们配置的 DNS 解析自动被识别到这里了。

![[public/blog/project/博客/个人部署方案/dns记录.png]]
...
![[public/blog/project/博客/个人部署方案/添加dns解析.png]]
...
![[public/blog/project/博客/个人部署方案/vercel-change-domian.png]]

成功之后，会显示如下

![[public/blog/project/博客/个人部署方案/changesuccess.png]]
