...
var l = defineComponent({
  ...
  setup(s) {
    const t = ref(false);
    return onMounted(() => {
      t.value = true, import("./giscus-aTimukGI-XRNP5P62.js");
...
// node_modules/.pnpm/vitepress-plugin-comment-with-giscus@1.1.15_vue@3.5.13_typescript@5.7.2_/node_modules/vitepress-plugin-comment-with-giscus/lib/giscus.js
